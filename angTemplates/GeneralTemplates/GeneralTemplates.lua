...
function ExtraItemButtonMixin:OnLoad()
    ...
    local newTexture3 = self.collapseFrame:CreateTexture("Angleur_NewTexture3", "ARTWORK")
    newTexture3:SetTexture("Interface/AddOns/Angleur/images/newfeature.png")
    newTexture3:SetSize(28, 24)
    newTexture3:SetPoint("LEFT", self.collapseFrame.expandButton, "RIGHT", 0, 0)

    local newTexture4 = self.collapseFrame.popup:CreateTexture("Angleur_NewTexture4", "ARTWORK")
    newTexture4:SetTexture("Interface/AddOns/Angleur/images/newfeature.png")
