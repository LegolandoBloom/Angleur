...
Legolando_EquipmentFlyoutPopoutButtonTemplateMixin_Angleur = {}
...
function Legolando_EquipmentFlyoutPopoutButtonTemplateMixin_Angleur:SetRotate(facing)
