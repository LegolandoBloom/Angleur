...
T["Debug Mode"] = "调试模式"
T["Defaults"] = "恢复默认"
T["Show/Hide visual with addon comp"] = "通过插件菜单显示/隐藏图标"
T["When checked, right-clicking the addon compartment button to sleep/wake will also show/hide the visual."] = "勾选后，右键插件菜单按钮切换休眠/唤醒时会显示或隐藏图标。"
T["Note:"] = "注意："
T["When unchecked, the visual will remain shown and be restored."] = "未勾选时，图标将保持显示并被恢复。"
